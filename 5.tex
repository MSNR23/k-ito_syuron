...
\begin{table}[tb]
  \begin{center}
    \caption{Parameters which are used for 3D rigid 2 links simulation}
    \tablabel{5.5}
    \begin{tabular}{c|c|c}
      \hline
      Parameters & Unit & Values \\
...
以上の設定をふまえ，腕の長さに応じた投擲フォームの強化学習を行った際の報酬の遷移を\figref{5.10.eps}に示す．身長1.72 m の人間に基づいた腕の長さによる遠投をするための投擲フォームは2983エピソード，身長1.90 m の人間に基づいた腕の長さによる遠投をするための投擲フォームは3060エピソードを採用した．
...
\clearpage
\figt{5.16.eps}{width=1.0\hsize}{Throwing form from start to release for 3D rigid 2 links from a plane \newline 　　　　perpendicular to the pitch axis（1.90 m tall human）}
\fig{5.17.eps}{width=1.0\hsize}{Throwing form from start to release for 3D rigid 2 links from a plane \newline 　　　　perpendicular to the roll axis（1.90 m tall human）}
\fig{5.8.eps}{width=1.0\hsize}{Transition of shoulder and elbow torque for 3D rigid 2 links from start to release\newline 　　　　（left:1.72 m tall human，right:1.90 m tall human）}
\fig{5.23.eps}{width=1.0\hsize}{Transition of shoulder 3 degrees of freedom and elbow 1 degree of freedom \newline 　　　　angular velocity from start to release for 3D rigid 2 links（left:1.72 m tall human，\newline 　　　　right:1.90 m tall human）}
\fig{5.24.eps}{width=1.0\hsize}{Transition of hand speed from start to release for 3D rigid 2 links（left:1.72 m\newline 　　　　 tall human，right:1.90 m tall human）}
\fig{5.25.eps}{width=1.0\hsize}{Transition of shoulder and elbow torque for 3D rigid 2 links（left:1.72 m tall \newline 　　　　human from 0.28 s to release，right:1.90 m tall human from 0.80 s to release）}
