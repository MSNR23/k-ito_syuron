...
この報酬により，4章の投射角$\times$手先速度よりも直接的に遠投をするための投擲フォームを導出することができる．また，2次元の際と同様に，罰則として累積消費エネルギーを採用し，\equref{5.11}で計算した．
...
　次に，重さ0.14 kg の投擲物と重さ7.24 kg の投擲物の際のそれぞれの上腕・前腕リンクの重心までの長さ，上腕・前腕リンクの慣性モーメント，肩関節の3軸周り・肘関節に与えるトルク，肩関節の3軸周り・肘関節の粘性係数について，表\tabref{5.3}に示す．各リンクの重心までの長さと慣性モーメントについての計算は，\equref{2.26}から\equref{2.31}を基に行った．各関節に与えるトルクについて，肩関節ピッチ軸周りとロール軸周り，肘関節はそれぞれ5種類のトルクから$epsilon$-greedy方に基づいて選択される．一方，肩関節ヨー軸周りのトルクについては，スプライン補間によって設定した可動範囲に基づき，可動範囲内にトルクが収まるように与えるトルクも補完する設定とした．
...
\fig{5.11.eps}{width=1.0\hsize}{Throwing form from start to release for 3D Rigid 2 Links from a plane perpendicular to the pitch axis（0.14 kg thrown object，1.72 m tall human）}
\fig{5.12.eps}{width=1.0\hsize}{Throwing form from start to release for 3D Rigid 2 Links from a plane perpendicular to the roll axis（0.14 kg thrown object，1.72 m tall human）}
\fig{5.13.eps}{width=1.0\hsize}{Throwing form from start to release for 3D Rigid 2 Links from a plane perpendicular to the pitch axis（7.24 kg thrown object）}
\fig{5.14.eps}{width=1.0\hsize}{Throwing form from start to release for 3D Rigid 2 Links from a plane perpendicular to the roll axis（7.24 kg thrown object）}
\fig{5.7.eps}{width=1.0\hsize}{Transition of shoulder 3 degrees of freedom and elbow 1 degree of freedom torque from start to release for 3D Rigid 2 Links（left: 0.14 kg thrown object，right: 7.24 kg thrown object）}
...
\figt{5.10.eps}{width=1.0\hsize}{Reward progress for 3D Rigid 2 Links（left:1.72 m tall human，right:1.90 m tall \newline human）}
...
\clearpage
\figt{5.16.eps}{width=1.0\hsize}{Throwing form from start to release for 3D Rigid 2 Links from a plane perpendicular to the pitch axis（1.90 m tall human）}
\fig{5.17.eps}{width=1.0\hsize}{Throwing form from start to release for 3D Rigid 2 Links from a plane perpendicular to the roll axis（1.90 m tall human）}
\fig{5.8.eps}{width=1.0\hsize}{Transition of shoulder and elbow torque for 3D Rigid 2 Links from start to release （left:1.72 m tall human，right:1.90 m tall human）}
\fig{5.23.eps}{width=1.0\hsize}{Transition of shoulder 3 degrees of freedom and elbow 1 degree of freedom angular velocity from start to release for 3D Rigid 2 Links（left:1.72 m tall human，right:1.90 m tall human）}
\fig{5.24.eps}{width=1.0\hsize}{Transition of hand speed from start to release for 3D Rigid 2 Links（left:1.72 me tall human，right:1.90 m tall human）}
\fig{5.25.eps}{width=1.0\hsize}{Transition of shoulder and elbow torque for 3D Rigid 2 Links（left:1.72 m tall human from 0.28 s to release，right:1.90 m tall human from 0.80 s to release）}
