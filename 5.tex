...
\clearpage
\fig{5.16.eps}{width=0.9\hsize}{Throwing form from start to release from a plane perpendicular to the pitch axis(1.90 m tall human)}
\figp{5.17.eps}{width=0.9\hsize}{Throwing form from start to release from a plane perpendicular to the roll axis(1.90 m tall human)}
